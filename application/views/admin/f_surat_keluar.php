...
<div class="navbar navbar-inverse">
	...
	<div class="col-lg-6">
		...
		<tr><td width="20%">Isi Ringkas</td><td><b><textarea name="uraian" required style="width: 400px; height: 60px" class="form-control"><?php echo $uraian; ?></textarea></b></td></tr>	
		<tr><td colspan="2">
	...
	<div class="col-lg-6">	
		<table width="100%" class="table-form">
			<tr><td width="20%">Kode Klasifikasi</td><td><b><input type="text" name="kode" required value="<?php echo $kode; ?>" id="kode_surat" style="width: 100px" class="form-control"></b></td></tr>
