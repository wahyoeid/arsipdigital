		...
		<tr>
			...
			<td class="ctr">
				<div class="btn-group">
					...
					<a href="<?=base_URL()?>admin/klas_surat/del/<?=$b->id?>" class="btn btn-warning btn-sm" title="Hapus Data" onclick="return confirm('Anda Yakin..?')"><i class="icon-trash icon-remove">  </i> Del</a>	
				</div>					
			</td>
			<?php 
			} else {
